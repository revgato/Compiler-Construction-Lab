...
Token* getToken(void) {
  ...
  case CHAR_LT:     //Dấu <
    ...
    readChar();
    if(charCodes[currentChar] == CHAR_EQ){    //Nếu kí tự tiếp theo là '=' thì sẽ là <= (SB_LE) (lessness or equality)
  ...
  case CHAR_GT:     //Dấu >
    ...
    readChar();
    if(charCodes[currentChar] == CHAR_EQ){    //Nếu kí tự tiếp theo là '=' thì sẽ là >= (SB_GE) (greaterness or equality)
  ...
  case CHAR_EXCLAIMATION:    //Dấu !
    ...
    if(charCodes[currentChar] == CHAR_EQ){    //Nếu kí tự tiếp theo là '=' thì sẽ là != (SB_NEQ)
      ...
      readChar();
      return token; 
    }else{                                    //Nếu không phải != thì là lỗi
